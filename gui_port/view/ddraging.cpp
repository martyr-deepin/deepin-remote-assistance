...
DDraging::DDraging(QFrame *parent) : QFrame(parent)
{
...
void DDraging::mousePressEvent (QMouseEvent *event)
   {
...
//           }
   ...
   void DDraging::mouseReleaseEvent(QMouseEvent *event)
   {
...
void DDraging::mouseMoveEvent ( QMouseEvent * event )
{
